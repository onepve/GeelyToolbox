...
export const store = reactive({
  ...
  vehicleAuto: {
    ...
    passenger_voice_role: 'princess', // 副驾角色音色: princess(公主) / queen(女王) / male(男声) / female(女声)
    voice_enable_door_fl: true,
    voice_enable_door_fl_close: true,
    voice_enable_door_fl_enter: true,
    voice_enable_door_fl_ready: true,
    voice_enable_door_fl_exit: true,
    voice_enable_door_fl_leave: true,
    voice_enable_door_fr: true,
    voice_enable_door_fr_close: true,
    voice_enable_door_fr_enter: true,
    voice_enable_door_fr_ready: true,
    voice_enable_door_fr_exit: true,
    voice_enable_door_fr_leave: true,

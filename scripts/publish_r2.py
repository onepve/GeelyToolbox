...
def main():
    ...
    if is_beta:
        ...
        meta = {
            ...
            "changelog": (
                "1. 手机无线快传 (8888) 实装专属语音制作中枢：提供轻量官方语音模板 (ZIP) 下载与规范 README 在线查阅\n"
                "2. 专属座舱语音 ZIP 自动穿透解压：手机快传或车机导入语音包全自动解压部署至 /sdcard/GeelyPilot/voices/ 专属目录\n"
                "3. 车载音频专区支持整套语音主题一键换装：展示已导入主题列表，支持样音试听、一键整套启用与彻底删除\n"
                "4. 全车声效个性化设置支持自由混搭：声效弹窗快捷矩阵直接选配已导入语音包中的特定音频，兼顾整套与单项自由组合"
            ),
            "release_date": today
        }

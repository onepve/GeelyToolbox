...
def main():
    ...
    if is_beta:
        ...
        meta = {
            ...
            "changelog": (
                "1. 车门与尾门全通道监听自愈：放宽底层日志过滤级别，增加原厂MCULog与core_server双通道兜底，彻底解决开关门无日志与无语音问题\n"
                "2. 方控 Mode 键打开 360 原厂多媒体防抢占：唤起 360 画面时后台自动秒级压制原厂伴听/多媒体抢前台，彻底根除画面被抢占顶替\n"
                "3. 运行与守护日志操作界面优化：弹窗底部固定新增【清空全部日志】与【刷新】大磁贴，防低版本WebView挤压，清空触手可及\n"
                "4. 手机网页端支持远程编辑TTS台词：无线快传网页端直接打字编辑并一键同步保存至车机，免去车机打字烦恼\n"
                "5. 手机网页端远程调起文件管理修复：补齐后端Action处理闭环，点击立即在车机拉起原生文件管理器\n"
                "6. 白天模式全场景输入框对比度自愈：彻底拔除死黑背景，采用自适应卡片底座，白天黑字夜间白字清澈清晰\n"
                "7. 商店未冻结横幅增强与夜间标题柔化：建议处置升级为高对比红底白字微胶囊，主标题柔化至 #E2E8F0 温润白"
            ),
            "release_date": today
        }

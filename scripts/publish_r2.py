...
def main():
    ...
    if is_beta:
        ...
        meta = {
            ...
            "changelog": (
                "1. 架构三权分立三大独立总开关落地：\\n"
                "   • 系统底层维护【桌面胶囊自启】：专管开机自启与悬浮小胶囊常驻，默认关闭，完全不影响语音与方控；\\n"
                "   • 车身智能联动【语音播报总闸】：优先判定全车声音总闸门，一键全车静音，独立生效；\\n"
                "   • 方向盘与方控【方控接管总开关】：独立控制按键接管，关闭时彻底100%放行给米小江或原厂，零冲突零抢占。\\n"
                "2. 抄取QQ音乐同款系统广播唤醒矩阵：监听蓝牙A2DP连接与亮屏解锁广播，车主靠近或解锁瞬间提前唤醒守护服务，彻底解决车机STR浅休眠开门不灵敏问题。\\n"
                "3. 抄取QQ音乐同款120ms功放上电避让与瞬态压音：开门语音引入120ms避让缓冲并申请瞬态压音焦点，与QQ音乐并存时自动平滑压音混音，绝不互抢，彻底消除首字吞字。"
            ),
            "release_date": today
        }

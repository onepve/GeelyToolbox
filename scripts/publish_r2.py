    ...
    if is_beta:
        ...
        meta = {
            ...
            "changelog": (
                ...
                "2. 语音引擎「解锁即预载」：车机解锁/上电瞬间提前预热，点火后第一句秒出（对标解锁自动播放体验）\n"
                "3. 修复档位播报、功能播报失效：上一版息屏被误判为熄火导致静音，已改用电瓶电压精准判定发动机状态\n"
                "4. 界面净化：去除点击按钮后的虚线焦点框\n"
                "5. 闲置屏保时长自由调节：3秒~10分钟，新增「永不」档，默认 30 秒"
            ),
            "release_date": today
        }

...
def main():
    ...
    if is_beta:
        ...
        meta = {
            ...
            "changelog": (
                "1. 全场景语音播报开关体系大一统：四大联动模块（挡位、模式、四门、尾门）全量统称为【xx播报】与【已开启/已关闭】家族式质感\n"
                "2. 挡位与模式按键全面升级双行质感：主标题明确显示为D挡播报/R挡播报/智能播报等，下方清晰直显已开启/已关闭，彻底消除单行生硬感\n"
                "3. 四门与尾门按键彻底告别绕口与歧义：统一对称重构为【开门播报】与【关门播报】，彻底杜绝开门防杀等生僻词与电动门误解\n"
                "4. 转向灯、大灯日夜与桌面悬浮胶囊状态显示统一规范：全栈开关状态指示全面收敛为【已开启 / 已关闭】"
            ),
            "release_date": today
        }

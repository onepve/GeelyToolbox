...
def main():
    ...
    if is_beta:
        ...
        meta = {
            ...
            "changelog": (
                "1. 车门全通道监听自愈与实时探针：放宽底层日志过滤级别，增加原厂MCULog与core_server双通道兜底，座舱直显车门物理电平微胶囊，彻底解决开关门无日志与无语音问题\n"
                "2. 语音播报音频输出通道三选一：新增媒体主声道、导航引导声道、系统通知声道自由切换与即时试听，兼顾听歌自动压音与防DSP衰减\n"
                "3. 方控 Mode 键打开 360 原厂多媒体防抢占：唤起 360 画面时后台自动秒级压制原厂伴听/多媒体抢前台，彻底根除画面被抢占顶替\n"
                "4. 专家模式三重安全确认与专属工具直出：恢复 1/3-3/3 严格安全风险确认向导，卡片内直接平铺全自动免电脑注入、半自动重写伪装主题与原生文件管理\n"
                "5. 手机无线快传网页彻底自愈：彻底根除转义导致的 JS 语法错误，扫码二维码实时动态拉取最新局域网 IP 并增设一键复制\n"
                "6. 运行与守护日志操作界面优化：弹窗底部固定新增【清空全部日志】与【刷新】大磁贴，防低版本WebView挤压，清空触手可及\n"
                "7. 白天模式全场景输入框对比度自愈与夜间标题柔化：彻底拔除死黑背景，采用自适应卡片底座，主标题柔化至 #E2E8F0 温润白"
            ),
            "release_date": today
        }

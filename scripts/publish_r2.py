    ...
    if is_beta:
        ...
        meta = {
            ...
            "changelog": (
                ...
                "5. 补齐系统级通道动态补音：彻底打通系统通知声道与音量动态增益调节联动\n"
                "6. 毫秒级熄火感知：接入onAccOff燃油服务底层广播，熄火下电复位更加干脆利落\n"
                "7. 日志无截断全量导出：彻底解除行数限制倾倒全量缓冲区，完美覆盖长时段路试\n"
                "8. 守护日志与终端双控倒序置顶：最新日志与命令结果高居最顶端，视口平稳0晃眼\n"
            ),
            "release_date": today
        }
